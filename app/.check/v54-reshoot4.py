...
SHOTS = [
    ('ww-close', 36.5, 17.2, 0.0, 1.5708, 0.0),    # 凹龛内向北看墙体窗（yaw=+π/2 面北）
    ('ww-foyer', 36.5, 12.5, 0.0, -1.5708, 0.0),   # 前厅侧向南看墙体窗
    ('walltv-close', 53.5, 27.6, 3.05, -1.5708, 0.05), # 2F 休息角向南看 walltv
]
