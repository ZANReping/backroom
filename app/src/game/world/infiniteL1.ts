      ...
      if (rng.chance(0.45)) {
        ...
        for (let tr = 0; tr < 20; tr++) {
          ...
          if (type === 'office') {
            ...
            // 大型医务室：床头贴北墙一张病床（v55 任务8：床头靠墙，deg=180 朝北），周围几张桌子
            // 北门洞正对时床让一列（门线正前方不放实心家具）
            const bxx = door[1] === ry - 1 && door[0] === cxx ? cxx - 1 : cxx
            pushStruct('bed', bxx, ry, 1, 1, true, false, { deg: 180 })
