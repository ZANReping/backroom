...
const RAW: RawEntry[] = [
  ...
  S('vent', '通风口', 'nonsolid', ['L0', 'L1', 'L2', 'L4', 'L5'], 'infinite L0–L2 placeWallHug；L4/L5 通用散点 ×3'),
  ...
  S('hoteldoor', '客房门', 'solid', ['L2', 'L4', 'L5', 'L9', 'L11'], 'infiniteL2 房间门、L4 办公室门、infiniteL5 客房门（25% 上锁可撬——有限 L5 房门锁机制保留）、L9/L11 房屋门'),
  ...
  S('hanglight', '吊线荧光灯', 'nonsolid', ['L0', 'L1', '据点103'], 'infinite L0/L1 placeFree；希波克拉底手术区无影灯'),
