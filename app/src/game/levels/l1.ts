...
export const L1: LevelDef = {
  ...
  lore: 'Level 1「Habitable Zone」。闷热（30–35°C）的非欧几里得空间，由诸多区段缝合而成：最常见的天鹰段形似停车场，从 Level 0 切入总会落在这里；跃金段更像仓库，照明斑斓、板条箱成群；哥特段充斥圆形拱门与圆柱；衔尾段永无止境地施工；花园段青翠明媚，却会让进入者患上「植殖癌」——行为僵硬、视野变绿，最终化为一株植物。狭窄如迷宫的维护通廊灯火通明，墨黑色金属门通往各个区段。天鹰、跃金、哥特三段不时发生「闪烁」：所有光源随机切断，实体倾巢而出。确认实体：无面灵、团块、猎犬、钝人、死亡飞蛾。——据 Backrooms Wikidot/Fandom 整理',
  ...
  structures: ['pillar', 'car', 'booth', 'graffiti', 'crate', 'corpse', 'vent', 'toolbox', 'locker', 'suitcase', 'rebar', 'pipes', 'roundarch', 'column', 'scaffold', 'roadblock', 'inkdoor', 'wheatpatch', 'hedgerow', 'glowshroom'],
  containerBias: 0.5,
