...
export const L8: LevelDef = {
  ...
  entities: [
    ...
    { type: 'deathrat', w: 14, min: 2, max: 5 },
  ...
  exitDesc: '出口：第九之路——一条有标记的路径，从来自 Level 6 的入口水池一路通到 Level 9 的出口，沿途穿过一系列「稳定之岛」，每约 50 米有一个带 M.E.G. 标志的路标，被认为是最安全的穿越方式；焦油池（→ Level 41 / 91，不可靠且不建议）；刻意向天顶 no-clip（→ Level 205）。另经 Rottnest Jungle 天顶的通风口可回 Level 2，但死亡鼠数量众多。',
  lightDensity: 0.006,
  darkness: 0.88,
}
