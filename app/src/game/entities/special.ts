...
export const SPECIAL_ENTITIES: Record<string, EntityDef> = {
  smiler: {
    type: 'smiler', name: '笑魇', hp: 40, speed: 2.4, damage: 22, sight: 7, hearing: 4, darkAmbusher: true, color: '#e8e8e0',
  ...
  arcwraith: {
    type: 'arcwraith', name: '电弧体', hp: 40, speed: 3.0, damage: 24, sight: 8, hearing: 2, jamsLight: true, color: '#9adfff',
