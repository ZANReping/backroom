...
export const CRITTER_ENTITIES: Record<string, EntityDef> = {
  ...
  hound: {
    ...
    codex: {
      ...
      behavior: '视力平平，但听觉半径极大，对奔跑脚步声尤其敏感——冲刺会把半个楼层外的它引来。Level 3 的个体智能显著更高：平日潜伏伏击，只在流浪者背对它们的瞬间发起攻击；被直视时会僵住不动。',
  ...
  clump: {
    ...
    codex: {
      ...
      behavior: '完全失明，依靠听觉捕猎。一旦听见脚步、搜索或碰撞声，会以远超目测的高速径直冲撞声源；抓住你时会将你拖住减速，臂展接近两米。Level 3 的个体体型更大、追逐更快，且会在追击中转弯——不再只是径直冲撞最后听见的声音。',
  ...
  deathmoth: {
    ...
    codex: {
      ...
      behavior: '被任何光源吸引，包括你的手电。扑到光上时会疯狂抓挠，快速消耗电池并遮挡视线。Level 3 的个体更倾向于集群出没——遇见一只时，附近往往还有一整群。',
  ...
  ferren: {
    ...
    codex: {
      ...
      lore: [
        ...
        'B.N.T.G. 为它修了雪貂笼，但更多时候它待在人的脚边。警备队长布洛克·奎坚称它不咬人——「至少没咬过我」。',
        '部分流浪者相信摸一摸 Ferren 的脑袋能带来好运。商人之家对此不予置评，但伤害 Ferren 的人会被请出市场。',
      ],
      sighting: '「它就卧在我的柜台下面。别踩到它，很贵。」——玛戈·坦恩，杂货摊主',
    },
    aggroStinger: false,
  },
  jerry: {
